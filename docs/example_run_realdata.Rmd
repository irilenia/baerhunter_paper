---
title: "Example run of baerhunter on real RNA-seq data"
...
In this example walkthrough, we reproduce the real-data analysis presented in the *baerhunter* paper (runs using a single set of parameters have been included but it is trivial to repeat with different parameters). The data originate from the Cortes et al. (2013) RNA-seq dataset (E-MTAB-1616). There is a separate R markdown document that reproduces the results of the analysis of simulated RNA-seq data.
...
m.Haning.res <- rbind(v.5_10, v.h.5_10, v.rh.02.40, v.rh.05.40)
...
rownames(m.Haning.res) <- c("bh_5-10", "bh_he_5-10", "rh_0.2-40", "rh_0.5-40")
...
m.TSS.res <- rbind(v.5_10, v.h.5_10, v.rh.02.40, v.rh.05.40)
...
rownames(m.TSS.res) <- c("bh_5-10", "bh_he_5-10", "rh_0.2-40", "rh_0.5-40")
